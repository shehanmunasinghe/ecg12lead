...
class SeparableConv1d(nn.Module):
    def __init__(self, n_filters_in, n_filters_out, kernel_size, stride=1, padding=0, dilation=1):
        # super(ECGNetLite.SeparableConv1d, self).__init__()
        super().__init__()

        self.conv1 = nn.Conv1d(n_filters_in, n_filters_in, kernel_size=kernel_size, stride=stride, padding=padding, 
                                dilation=dilation, groups=n_filters_in) 
        self.pointwise = nn.Conv1d(n_filters_in,n_filters_out,kernel_size=1)
...
class ECGNetLite(nn.Module):
    ...
    def __init__(self, input_channels=12, N_labels=2, kernel_size =17,  n_blocks=4):
        ...
        # self.conv1 = SeparableConv1d(input_channels, 64, kernel_size=kernel_size, padding=self.padding) # input_channelsx4096 -> #64x4096
    ...
    class ResBlock(nn.Module):
        def __init__(self, n_filters_in, n_samples_in, n_filters_out, n_samples_out,
            ...
            super(ECGNetLite.ResBlock, self).__init__()
            ...
            self.conv1 = SeparableConv1d(n_filters_in, n_filters_out, kernel_size=kernel_size, padding=self.padding) 
            ...
            self.conv2 = SeparableConv1d(n_filters_out, n_filters_out, kernel_size=kernel_size, stride=downsample, padding=self.padding) 
            
            self.sk_max_pool= nn.MaxPool1d(downsample)
            # self.sk_conv = nn.Conv1d(n_filters_in, n_filters_out, kernel_size=1) 
            self.sk_conv = SeparableConv1d(n_filters_in, n_filters_out, kernel_size=1) 
